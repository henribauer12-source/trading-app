...
date: 20260925
status: v1.6; independently reviewed up to v1.2, findings incorporated; additions in v1.3 (A5.1, A5.2), v1.4 (A5.1, A5.2, A5.3, A5.5), v1.5 (A1 P18, A2.5–A2.7, TA23–TA27) and v1.6 (A5.1, A5.2, A15) not yet independently reviewed
owner: Henri
...
# Investment Specification v1.6 – "Anlegen" (Invest) Core Module
...
| Building block | Permitted indices |
|---|---|
