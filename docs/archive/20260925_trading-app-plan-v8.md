...
date: 20260925
status: Entwurf v8 (ersetzt v7; Grundlagen: 20260924_trading-app-research.md, 20260924_trading-app-qualitaetsstandards.md, 20260925_rechenkern-spezifikation-v1.4.md, 20260925_strategie-katalog.md)
owner: Henri
---

# Trading-Analyse-App – Projektplan v8
...
Ein privates Analysewerkzeug, das evidenzbasierte Signale anzeigt, jeweils mit Trefferquote, Unsicherheit und Risiko, und dir dabei Trading und langfristiges Anlegen beibringt. Die Verbindung zu einem Broker-Konto ist optional. Fünf Module auf einer gemeinsamen Engine:
...
| Langfrist | Allokation und Trendsignale für UCITS-ETFs und große Aktien | Monatlich |
...
| Prediction Engine | Aktien-Rangliste mit kalibrierter Wahrscheinlichkeit, sich über 1–3 Monate besser zu entwickeln als der Median der großen Aktien (Teil des Bereichs Signale) | Monatlich |
...
|---|---|---|
| Produkte | Möglichst alle handelbaren Produkte, inkl. Optionen | Instrument-Modell mit eigenem Kosten- und Risikoprofil pro Klasse; Hebelprodukte und Optionen erst ab Phase 6/7 |
...
│ Signale │ Portfolio │ Markt-Intelligenz │ Optionen │ Lernen │ Evidenz │ Backtests │ Risiko │
└───────────────────────────────────────────┬──────────────────────────────────────────────┘
                                            │
┌──────────────┐   ┌────────────────────────┴───────────────────────┐   ┌──────────────────┐
│ Datenschicht │──▶│ Signal-Engine                                  │──▶│ Risikomodul      │
│ IBKR         │   │ Trading │ Langfrist │ Options-Bewertung         │   │ Sizing, Limits,  │
...
### 4.5 Trading- und Langfrist-Modul
Unverändert gegenüber v1, mit einer Änderung: Das Langfrist-Universum besteht aus UCITS-ETFs.

| | Trading | Langfrist |
|---|---|---|
| Strategiefamilien (vorläufig) | Time-Series-Momentum, Trendfolge, Breakouts, Mean Reversion | Trendfilter (10-Monats-Durchschnitt), Cross-Sectional-Momentum, ggf. Faktoren |
| Output | Richtung, Einstieg, Stop, Ziel, Trefferquote mit Konfidenzintervall | Soll- vs. Ist-Allokation, Umschichtungsvorschlag |
...
|---|---|---|
| 1: Fundament | Rendite und Risiko, Diversifikation, Kosten, Zinseszins, Sparplan, Weltportfolio mit UCITS-ETFs, Steuern (Abgeltungsteuer, Sparerpauschbetrag, Anlage KAP) | Langfrist-Modul |
| 2: Wie man Evidenz liest | Backtest vs. Realität, Overfitting, Konfidenzintervalle, Publikationseffekt, warum Gurus nicht funktionieren | Evidenz- und Backtest-Ansicht |
...
|---|---|---|
| Übersicht | – | Was ist heute wichtig? (3–5 Karten: neue Signale, Portfolio-Stand, Risiko-Warnungen, Lernimpuls) |
| Signale | Swing · Intraday · Langfrist · Aktien-Ranking | Was sagen die Strategien und die Prediction Engine, und warum? |
...
2. **Mockups** der fünf Kernseiten (Übersicht, Signaldetail, Portfolio, Briefing, Lernpfad) als Design-Artefakt zum Durchklicken und Kommentieren, bevor Code entsteht.
...
| 2b: UI-Konzept | Mobbin-Recherche, ästhetische Richtung, Mockups der fünf Kernseiten | Mockups von dir freigegeben |
| 3: Langfrist-Modul + Lernstufen 1–2 | Strategien testen, erstes Dashboard nach freigegebenem UI-Konzept, "Warum?"-Panels, Glossar | ≥ 1 Strategie besteht alle Prüfungen out-of-sample; Lektionen 1–2 fertig; Design-Review bestanden |
...
| Keine Strategie oder kein Tilt überlebt | Valides Ergebnis; App zeigt "kein Signal", Langfrist-Trendfilter bleibt Basis |
| Hebel und Optionen | Erst ab Phase 6/7, Starter-Set, Maximalverlust-Regeln, Stresstests |
...
Siehe `20260924_trading-app-research.md` (vollständige Quellenliste) und `20260924_trading-app-qualitaetsstandards.md`. Zusätzlich:
